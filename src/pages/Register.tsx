...
const Register: React.FC = () => {
  ...
  return (
    <div className={`academic-canvas app-surface min-h-screen transition-all duration-500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      ...
      {/* Main Content */}
      <main className="register-container min-h-screen flex items-center justify-center px-3 sm:px-4 md:px-6 pt-12 sm:pt-14 md:pt-16">
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-4 md:gap-6 lg:gap-8 items-center">
          ...
          <div className="hidden md:block relative illustration h-full">
            <div className="relative z-10 h-full flex items-center justify-center">
              <div
                className="bg-gradient-to-br from-indigo-500/20 to-pink-500/20 rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 backdrop-blur-sm w-full h-full min-h-[500px] flex items-center justify-center"
              >
          ...
          <div className="w-full max-w-xs md:max-w-sm lg:max-w-md mx-auto md:mx-0">
            <div className="register-card bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl lg:rounded-3xl shadow-lg md:shadow-xl lg:shadow-2xl border border-gray-100 dark:border-gray-700 transform transition-all duration-500 hover:scale-[1.02]">
              ...
              <div className="md:hidden text-center mb-3">
                ...
                <h2
                  className="text-base sm:text-lg md:text-xl font-bold text-gray-900 dark:text-white font-japanese"
