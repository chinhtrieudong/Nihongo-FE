...
import { Button, Card, Select, Badge, Avatar, Typography, Row, Col, message, Spin, Tag, Space } from "antd";
import { RobotOutlined, UserOutlined, BookOutlined, PlayCircleOutlined, ClockCircleOutlined, StarOutlined } from "@ant-design/icons";
    ...
    return (
        <div className="p-6 bg-secondary-50 dark:bg-secondary-950 min-h-screen">
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <Title level={1} className="!mb-2 text-secondary-900 dark:text-secondary-100">
                        🗣️ Bài học hội thoại
                    </Title>
                    <Text className="text-lg text-secondary-600 dark:text-secondary-400">
                        Luyện tập hội thoại tiếng Nhật theo phương pháp Duolingo - Nghe → Hiểu → Nói → Lặp lại
                    </Text>
                </div>

                {/* Filters */}
                <Card className="mb-6 shadow-sm">
                    <Title level={4} className="!mb-4 text-secondary-900 dark:text-secondary-100">
                        Bộ lọc
                    </Title>
                    <Row gutter={[16, 16]}>
                        <Col xs={24} sm={8} md={6}>
                            <div className="mb-2">
                                <Text strong className="text-sm">Trình độ:</Text>
                            </div>
                            <Select
                                value={filters.level}
                        ...
                        <Col xs={24} sm={8} md={6}>
                            <div className="mb-2">
                                <Text strong className="text-sm">Danh mục:</Text>
                            </div>
                            <Select
                        ...
                        <Col xs={24} sm={8} md={6}>
                            <div className="mb-2">
                                <Text strong className="text-sm">Độ khó:</Text>
                            </div>
                            <Select
