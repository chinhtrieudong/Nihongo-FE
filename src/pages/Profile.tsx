...
import { Card, Row, Col, Progress, Avatar, Typography, Space, Statistic } from "antd";
import { UserOutlined, TrophyOutlined, BookOutlined, FireOutlined, StarOutlined } from "@ant-design/icons";
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card>
            ...
            <div className="mt-3">
              ...
              <Text type="secondary" className="text-xs">Khóa học {currentUser?.currentLevel || 'N5'}</Text>
            </div>
          </Card>
        </Col>
          ...
          <Card title="Thông tin cá nhân">
            <Space orientation="vertical" className="w-full" size="middle">
              ...
              <div className="flex justify-between">
                ...
                <Text>{currentUser?.createdAt ? new Date(currentUser.createdAt).toLocaleDateString('vi-VN') : new Date().toLocaleDateString('vi-VN')}</Text>
              </div>
              <div className="flex justify-between">
                <Text strong>Trình độ hiện tại:</Text>
                <Text color="blue">{currentUser?.currentLevel || 'N5'} Beginner</Text>
              </div>
            </Space>
          </Card>
        </Col>
          ...
          <Card title="Thành tựu">
            <Space orientation="vertical" className="w-full" size="middle">
              <div className="text-center py-4">
                ...
                <Text type="secondary" className="text-xs">Hoàn thành bài học để nhận thành tựu</Text>
              </div>
            </Space>
          </Card>
        </Col>
        ...
        <Space orientation="vertical" className="w-full" size="middle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-lg">
              ...
              <div className="mt-2">
                <Text type="secondary" className="text-sm">Quản lý thông báo học tập</Text>
              </div>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg">
              <Text strong>Quyền riêng tư</Text>
              <div className="mt-2">
                <Text type="secondary" className="text-sm">Cài đặt bảo mật và quyền riêng tư</Text>
              </div>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg">
              <Text strong>Giao diện</Text>
              <div className="mt-2">
                <Text type="secondary" className="text-sm">Tùy chỉnh giao diện ứng dụng</Text>
              </div>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg">
              <Text strong>Tài khoản</Text>
              <div className="mt-2">
                <Text type="secondary" className="text-sm">Quản lý thông tin tài khoản</Text>
              </div>
            </div>
          </div>
        </Space>
